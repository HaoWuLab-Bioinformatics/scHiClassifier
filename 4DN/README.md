...
4. The folder "**train&test**" contains the 这个文件夹中包含了scHiClassifier框架在训练集上训练并在测试集上测试的代码。其中"**focal_loss_GPU0.py**","**focal_loss_GPU1.py**","**focal_loss_GPU2.py**"和"**focal_loss_GPU3.py**"分别指的是调用不同GPU来进行
