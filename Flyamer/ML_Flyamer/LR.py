...
def main():
    ...
    for zuhe in zuhes.values():
        ...
        for testseed in testseed_list:
            ...
            row += 1
            test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc = machinelearning_LR(f1_Data, f2_Data, f3_Data, f4_Data, x_train, y_train, x_test, y_test)
            print("=============")
