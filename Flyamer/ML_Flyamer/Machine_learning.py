...
def machinelearning_SVM(f1_Data, f2_Data, f3_Data, f4_Data, x_train, y_train, X_test, Y_test):
    ...
    best_parameters, test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc = SVM(Train_X, Train_Y, Test_X, Test_Y)
    result = [best_parameters, test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc]
    return result
...
def machinelearning_LR(f1_Data, f2_Data, f3_Data, f4_Data, x_train, y_train, X_test, Y_test):
    ...
    best_parameters, test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc = logistic_Reg(Train_X, Train_Y, Test_X, Test_Y)
    result = [best_parameters, test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc]
    return result
...
def machinelearning_RF(f1_Data, f2_Data, f3_Data, f4_Data, x_train, y_train, X_test, Y_test):
    ...
    best_parameters,test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc = randomForest(Train_X, Train_Y, Test_X, Test_Y)
    result = [best_parameters, test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc]
    return result
...
def Search(train_model,params, Train_X,Train_Y, Test_X, Test_Y):
    ...
    best_parameters = train_model.best_estimator_.get_params()
    ...
    return best_parameters,test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc
...
def SVM(Train_X, Train_Y, Test_X, Test_Y):
    ...
    best_parameters,test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc = Search(train_model, params, Train_X, Train_Y, Test_X, Test_Y)
