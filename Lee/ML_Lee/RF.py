...
from Machine_learning import machinelearning_RF
...
def main():
    ...
    testseed_list = [735715, 468261, 884807, 408141, 335839, 598764, 353617, 664118, 104908, 822596,
                     ...
                     960948, 972593, 185272, 17889, 221168, 380684, 653430, 132226, 890591, 820294,
                     40803, 162059, 503280, 944383, 468642, 557513, 357992, 79616, 563898, 483552,
    ...
    for zuhe in zuhes.values():
        ...
        for testseed in testseed_list:
            ...
            row += 1
            test_acc, micro_F1, macro_F1, micro_Precision, macro_Precision, micro_Recall, macro_Recall, bacc, mcc = machinelearning_RF(
