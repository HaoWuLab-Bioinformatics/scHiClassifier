...
def CNN_1D_montage(f1_Data, f2_Data, f3_Data, f4_Data, x_train, y_train, X_test, y_test, lr, model_para, alpha, gamma, batch_size):
    ...
    # print(train_X_NBCP3.shape)  # torch.Size([415, 1, 2660])
    # print(train_X_SBCP.shape)   # torch.Size([415, 1, 2660])
    # print(test_X_NBCP3.shape)   # torch.Size([103, 1, 2660])
    # print(test_X_SBCP.shape)    # torch.Size([103, 1, 2660])
